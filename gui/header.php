        ...
        <div class="bg-primary" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <?php if (is_authenticated()): ?>
                    ...
                    <a href="index.php?page=interview_slots" class="list-group-item list-group-item-action bg-primary text-white border-0 <?php echo (isset($_GET['page']) && $_GET['page'] == 'interview_slots') ? 'active' : ''; ?>">
                        <i class="bi bi-calendar-check me-2"></i> Interview Slots
                    </a>
